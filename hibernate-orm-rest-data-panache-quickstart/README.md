# Quarkus demo: Hibernate ORM REST Data with Panache
...
To find more features, please go to [the Hibernate ORM REST Data with Panache guide](https://quarkus.io/guides/rest-data-panache).